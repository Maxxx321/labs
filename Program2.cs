...
class Program
{
    public static void Main()
    {
        ...
        Car aaaa = new Car("egweg", 100000000, 202, 1998, "Shiguli");
        aaaa.napechat();
        Plane eeee = new Plane("gwege", 10000000000, 2020, 1998, 4000, 212);
        eeee.napechat();
        Ship rrrr = new Ship("regbg", 10000000000, 2020, 1998, 212, "Sevastopol");
        rrrr.napechat();
        ...
        if (aeae == "195634746868")
        {
            erer = new ProDocumentWorker();
        }
        else if (aeae == "212230262624")
        {
